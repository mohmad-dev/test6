      ...
      <div className='categories-wrapper'>
        ...
        <div className='categories'>
          <NavLink
            ...
            data-label='soulful'
            onMouseEnter={() => handleMouseEnter('soulful', 0)}
          ...
          <NavLink
            ...
            className='categories-block'
            data-label='mosaic'
            onMouseEnter={() => handleMouseEnter('mosaic', 1)}
            onMouseLeave={handleMouseLeave}>
            <h2 className='categories-block__text'>
              <div className='categories-block__text_first-title'>
          ...
          <NavLink
            ...
            className='categories-block'
            data-label='emt'
            onMouseEnter={() => handleMouseEnter('emt', 2)}
            onMouseLeave={handleMouseLeave}>
            <h2 className='categories-block__text'>
              <div className='categories-block__text_first-title'>
          ...
          <NavLink
            ...
            className='categories-block'
            data-label='cyberfam'
            onMouseEnter={() => handleMouseEnter('cyberfam', 3)}
            onMouseLeave={handleMouseLeave}>
            <h2 className='categories-block__text'>
              <div className='categories-block__text_first-title'>
          ...
          <NavLink
            ...
            onMouseEnter={() => handleMouseEnter('tritochki', 4)}
            onMouseLeave={handleMouseLeave}>
            <h2 className='categories-block__text'>
              <div className='categories-block__text_first-title'>
          ...
          <NavLink
            ...
            className='categories-block'
            data-label='td'
            onMouseEnter={() => handleMouseEnter('td', 5)}
            onMouseLeave={handleMouseLeave}>
            <h2 className='categories-block__text'>
              <div className='categories-block__text_first-title'>
